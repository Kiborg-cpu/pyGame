...
class Player(pygame.sprite.Sprite):
    ...
    def animate(self):
        self.move_animations = [self.game.character_spritesheet.get_sprite(41, 2, 13, 27),
                                self.game.character_spritesheet.get_sprite(73, 2, 13, 27)]
...
class Enemy(pygame.sprite.Sprite):
    ...
    def animate(self):
        self.move_animations = [self.game.enemy_spritesheet.get_sprite(11, 37, 13, 27),
                                self.game.enemy_spritesheet.get_sprite(11, 69, 13, 27)]
        self.image = self.move_animations[math.floor(self.animation_loop)]
